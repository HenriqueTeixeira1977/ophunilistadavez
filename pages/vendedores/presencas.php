    ...
    <td>
        <form method="POST" action="salvar_presenca.php">
            ...
            <select name="status" 
                ...
                <option value="">-</option>
                <option value="trabalhou" <?= $status=='trabalhou'?'selected':'' ?>>T</option>
                <option value="folga" <?= $status=='folga'?'selected':'' ?>>F</option>
                <option value="falta" <?= $status=='falta'?'selected':'' ?>>X</option>
                <option value="ferias" <?= $status=='ferias'?'selected':'' ?>>FR</option>
                <option value="atestado" <?= $status=='atestado'?'selected':'' ?>>AT</option>
            </select>
        </form>
    </td>
